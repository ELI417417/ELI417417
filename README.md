...
**🎯 Focus**
- Computer Vision (Classification, Detection, GANs, 3D)
- Large Language Models (LoRA, Transformers, Diffusion)
- Model deployment (ONNX, Flask, Streamlit)
- Reproducible ML (MLflow, DVC, Hydra)

</td>
<td width="50%">

**🛠️ Core Stack**
`PyTorch` · `TensorFlow` · `Transformers` · `OpenCV` · `ONNX Runtime`
`FAISS` · `scikit-learn` · `Streamlit` · `Flask` · `FastAPI`
`Plotly` · `MLflow` · `DVC` · `Docker` · `Git`
`Python` · `C++` · `C` · `SQL` · `CMake`
...
|-------|-------|-------------------|
| Attention Is All You Need (Vaswani et al.) | NeurIPS 2017 | [**Transformer From Scratch**](https://github.com/ELI417417/transformer-from-scratch) |
| Deep Residual Learning (He et al.) | CVPR 2016 | [**ResNet From Scratch**](https://github.com/ELI417417/resnet-from-scratch) |
| DCGAN (Radford et al.) | ICLR 2016 | [**DCGAN Image Generation**](https://github.com/ELI417417/dcgan-image-generation) |
| Neural Style Transfer (Gatys et al.) | 2015 | [**Neural Style Transfer**](https://github.com/ELI417417/neural-style-transfer) |
| ViT (Dosovitskiy et al.) | ICLR 2021 | [**Vision Transformer**](https://github.com/ELI417417/vision-transformer-cifar100) |
| PointNet (Qi et al.) | CVPR 2017 | [**PointNet 3D**](https://github.com/ELI417417/pointnet-3d-classification) |
| LoRA (Hu et al.) | ICLR 2022 | [**LoRA Fine-tuning**](https://github.com/ELI417417/lora-finetuning) |
| CLIP (Radford et al.) | ICML 2021 | [**CLIP Semantic Search**](https://github.com/ELI417417/clip-semantic-search) |
...
2024 ─┬─ Feb  <a href="https://github.com/ELI417417/sentiment-analyzer">Sentiment Analyzer</a>          scikit-learn · Flask
      ├─ Mar  <a href="https://github.com/ELI417417/task-manager">Task Manager</a>               FastAPI · SQLite · JS
      ├─ Jun  <a href="https://github.com/ELI417417/dcgan-image-generation">DCGAN Generator</a>             PyTorch · Streamlit
      ├─ Aug  <a href="https://github.com/ELI417417/transformer-from-scratch">Transformer</a>                PyTorch · Attention
      ├─ Sep  <a href="https://github.com/ELI417417/vision-transformer-cifar100">Vision Transformer</a>         PyTorch · CIFAR-100
      ├─ Oct  <a href="https://github.com/ELI417417/yolo-object-detection">YOLO Detector</a>              ONNX · Flask · OpenCV
      ├─ Nov  <a href="https://github.com/ELI417417/mobilenet-ssd-deployment">MobileNet-SSD Edge</a>         ONNX · CPU Benchmark
...
2025 ─┬─ Jan  <a href="https://github.com/ELI417417/neural-style-transfer">Style Transfer</a>             VGG19 · PyTorch
      ...
      ├─ Jun  <a href="https://github.com/ELI417417/pointnet-3d-classification">PointNet 3D</a>               Open3D · ModelNet40
      └─ Jul  <a href="https://github.com/ELI417417/realtime-video-analytics">Video Analytics</a>            Real-time · Dashboard
</pre>
